 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (tsk_sender) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 3))
    #define TASK_4_STACK_SIZE 2000/4 // size = 2000 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_tft) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 2000/4 // size = 2000 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_uart) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 5))
    #define TASK_6_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_glower) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 6))
    #define TASK_7_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_7[TASK_7_STACK_SIZE];	/* Task 7 (tsk_glower) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_sender*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_tft*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_uart*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_glower*/
        #endif
        #ifdef TASK_7_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_7[(TASK_7_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_glower*/
        #endif
        #ifdef TASK_8_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 2
    DeclareTask(tsk_sender);
    #endif
    #if EE_MAX_TASK > 3
    DeclareTask(tsk_tft);
    #endif
    #if EE_MAX_TASK > 4
    DeclareTask(tsk_uart);
    #endif
    #if EE_MAX_TASK > 5
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread tsk_sender */
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_tft */
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread tsk_uart */
    #endif
    #if EE_MAX_TASK > 5
